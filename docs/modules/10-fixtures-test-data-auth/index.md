...
- встроенные и custom fixtures;
- организация типизированных test data;
- подготовка и безопасное хранение состояния auth.

## Минимальный результат

После модуля студент должен уметь:

- создать custom fixture;
- передать тесту подготовленные данные или Page Object;
- описать настройку `storageState` без добавления секретов в Git.
