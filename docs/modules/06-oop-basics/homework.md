...
git switch --track origin/student/{student-name-slug}/module-06-oop-basics
...
- Использована подготовленная ветка `student/{student-name-slug}/module-06-oop-basics`.
