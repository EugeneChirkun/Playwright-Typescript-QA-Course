...
Используйте Codex для небольших изменений документации, обновления структуры, навигации и проверки консистентности. Codex должен сохранять русские объяснения, оставлять общепринятую техническую терминологию на English там, где это естественно, и не делать большие переписывания без явного запроса.
