...
## Задание 2. Создать Playwright-проект
...
Запустите тест и проверьте результат в терминале и HTML report.
...
3. В описании PR или сообщении укажите:
   ...
   - прошли ли тесты;
   - ссылку на скриншот или вывод терминала, если это нужно для проверки.
