...
- первые типы TypeScript;
- простые QA-примеры с условиями, массивами и функциями.

## Минимальный результат

После модуля студент должен уметь:

- создать переменные, массивы и объекты;
- написать простое условие и функцию;
- добавить базовые типы без усложнения модели данных.
...
1. Открыть репозиторий домашних заданий в VS Code.
